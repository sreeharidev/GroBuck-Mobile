...
export default class Home extends Component{
    ...
    constructor(props){
        ...
        this._showCart = this._showCart.bind(this);
    ...
    render() {
      ...
      <View style={{flex: 1}}>
        ...
        <Header title="GroBuck" _showCart= {this._showCart} _shopListCallBack ={this._onShopClick} shopIcon={this.state.shopIcon} cartCount={this.state.shopData.cartCount} />  
        <ScrollView>
          <Image style={{width: window.width,marginTop:5, height: 200,backgroundColor:"#F9F8F6"}} source={{uri: Config.SERVER_IP+":3000/imgs/"+this.state.shopData.banner}}  />
          {this.getProductList()}
        </ScrollView>
